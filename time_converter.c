    ...
    do{
        ...
        switch(choice){
            case 1: printf(" ______________SOBRE O PROGRAMA______________\n");
                    ...
                    printf("|                Integrantes                 |\n");
                    printf("|                                            |\n");
                    printf("|André Seiki Nagaishi\tProntuário: 196106-3 |\n");
                    printf("|Gabriel Santos Sá\tProntuário: 300546-1 |\n");
                    printf("|                                            |\n");
...
int main(){
    ...
    printf("Bem vindo ao Projeto Final de APO, o Conversor de Tempo.\n");
